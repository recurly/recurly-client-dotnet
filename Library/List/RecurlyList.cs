...
namespace Recurly
{
    ...
    public abstract class RecurlyList<T> : IEnumerator<T>
    {
        ...
        internal string PostUrl
        {
            get
            {
                return
                    this.BaseUrl + "&per_page=" + Configuration.Section.Current.PageSize +
                    (_cursor != null ? "&cursor=" + _cursor : "");
            }
        }
        ...
        {
            Client.PerformRequest(Client.HttpRequestMethod.Get, this.BaseUrl + this.PostUrl, new Client.ReadXmlListDelegate(this.ReadXmlList));
        }
