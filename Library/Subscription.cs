...
namespace Recurly
{
    public class Subscription
    {
        ...
        public static Subscription Get(string accountCode)
        {
            return Get(new Account(accountCode));
        }

        public static Subscription Get(Account account)
        {
            Subscription sub = new Subscription(account);

            HttpStatusCode statusCode = Client.PerformRequest(Client.HttpRequestMethod.Get,
                SubscriptionUrl(account.AccountCode),
                new Client.ReadXmlDelegate(sub.ReadXml)).StatusCode;
        ...
        {
            Client.PerformRequest(Client.HttpRequestMethod.Delete, SubscriptionUrl(accountCode));
        }
        ...
        {
            Client.PerformRequest(Client.HttpRequestMethod.Post, SubscriptionUrl(accountCode) + "/reactivate");
        }
        ...
        public static void RefundSubscription(string accountCode, RefundType refundType)
        {
            ...
            Client.PerformRequest(Client.HttpRequestMethod.Delete, refundUrl);
        }
