...
namespace Recurly.Resources
{
    ...
    public class GiftCardDeliveryCreate : Request
    {
        ...
        /// <value>The email address of the recipient. Required if `method` is `email`.</value>
        ...
        /// <value>Address information for the recipient. Required if `method` is `post`.</value>
