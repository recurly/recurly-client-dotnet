...
namespace Recurly.Resources 
{
    ...
    public class ListUsageParams : OptionalParams
    {
        ...
        /// <value>Sort field. You *really* only want to sort by `usage_timestamp` in ascending  order. In descending order updated records will move behind the cursor and could  prevent some records from being returned.  </value>
        [JsonProperty("sort")]
        public Constants.UsageSort? Sort { get; set; }
        
        /// <value>Inclusively filter by begin_time when `sort=usage_timestamp` or `sort=recorded_timestamp`.  **Note:** this value is an ISO8601 timestamp. A partial timestamp that does not include a time zone will default to UTC.  </value>
        [JsonProperty("begin_time")]
        public DateTime? BeginTime { get; set; }
        
        /// <value>Inclusively filter by end_time when `sort=usage_timestamp` or `sort=recorded_timestamp`.  **Note:** this value is an ISO8601 timestamp. A partial timestamp that does not include a time zone will default to UTC.  </value>
        [JsonProperty("end_time")]
        public DateTime? EndTime { get; set; }
        
        /// <value>Filter by usage record's billing status</value>
