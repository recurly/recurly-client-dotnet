...
namespace Recurly.Resources 
{
    ...
    public class ListInvoiceTemplateAccountsParams : OptionalParams
    {
        ...
        /// <value>Filter for accounts with this exact email address. A blank value will return accounts with both `null` and `""` email addresses. Note that multiple accounts can share one email address.</value>
        [JsonProperty("email")]
        public string Email { get; set; }
        
        /// <value>Filter for accounts with or without a subscription in the `active`,  `canceled`, or `future` state.  </value>
